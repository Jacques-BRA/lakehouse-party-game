...
const PROMPTS = [
  ...
  // ---- 100 more, Quiplash-style ----
  'A weird thing to be voted "Most Likely To" in your high school yearbook',
  'The real reason aliens haven\'t visited Earth yet',
  'A terrible name for a boat',
  'Something you should never say to your boss but really want to',
  'The worst possible thing to find in your sandwich',
  'A rejected flavor of toothpaste',
  'A bad name for a superhero whose only power is being slightly damp',
  'The worst thing to say to your barber mid-haircut',
  'A terrible slogan to print on a baby onesie',
  'Something a dog would say if it could talk for one minute',
  'The worst possible name for a hurricane',
  'A bad thing to be enthusiastic about',
  'The worst gift to give your in-laws',
  'A terrible name for a cologne aimed at teenage boys',
  'Something you should not do during a job interview',
  'The worst way to start a wedding speech',
  'A rejected Olympic sport',
  'The worst thing to say right before "I do"',
  'A terrible theme for a children\'s birthday party',
  'Something you\'d be surprised to hear a grandma say',
  'The worst name for a new ice cream truck',
  'A bad reason to pull the fire alarm',
  'The worst thing to whisper during a hug',
  'A terrible name for a law firm',
  'Something that would make a terrible ringtone',
  'The worst thing to find written in your yearbook',
  'A bad name for a haunted house attraction',
  'The worst possible use for a million dollars',
  'A terrible thing to say to your dentist',
  'Something you should never microwave',
  'The worst superpower to have on a first date',
  'A bad name for a cruise ship buffet',
  'The worst thing to hear right before surgery',
  'A terrible idea for a new reality TV show',
  'Something a cat is definitely judging you for',
  'The worst thing to say to a cop who pulled you over',
  'A bad name for a perfume aimed at goblins',
  'The worst way to announce you\'re quitting your job',
  'A terrible thing to say at a funeral',
  'Something you\'d regret getting tattooed',
  'The worst name for a children\'s cereal',
  'A bad pickup line guaranteed to fail',
  'The worst thing to find in a public pool',
  'A terrible name for a daycare run by clowns',
  'Something you should never bring to a first date',
  'The worst possible password',
  'A bad name for a yoga studio',
  'The worst thing to say to your therapist',
  'A terrible new Olympic event for the elderly',
  'Something that would ruin a romantic dinner',
  'The worst name for a guard dog who is actually very sweet',
  'A bad thing to shout during a yoga class',
  'The worst thing to keep in the office fridge',
  'A terrible motivational quote for Monday mornings',
  'Something you\'d find in a vampire\'s lunchbox',
  'The worst name for a pirate ship',
  'A bad reason to be late to your own wedding',
  'The worst thing to say to a flight attendant',
  'A terrible name for a heavy metal band made of accountants',
  'Something a toddler would do if they ran the country',
  'The worst possible thing to be afraid of',
  'A bad name for a fast food mascot',
  'The worst thing to find in your hotel mini-fridge',
  'A terrible new emoji we definitely don\'t need',
  'Something you should never say while getting a massage',
  'The worst thing to name your Wi-Fi network',
  'A bad theme for a retirement party',
  'The worst possible halftime show',
  'A terrible name for a brand of energy drink',
  'Something a ghost would complain about',
  'The worst advice to give before a big date',
  'A bad name for a children\'s puppet',
  'The worst thing to do at a silent meditation retreat',
  'A terrible product to advertise during the Super Bowl',
  'Something you\'d be embarrassed to be caught singing',
  'The worst name for a new planet we discover',
  'A bad reason to call 911',
  'The worst thing to say to your Uber driver',
  'A terrible name for a wrestler whose gimmick is being polite',
  'Something that does not belong in a smoothie',
  'The worst possible thing to be the world record holder for',
  'A bad name for a romance novel',
  'The worst thing to teach your kid as their first word',
  'A terrible new feature for an airplane',
  'Something a wizard would put on his résumé',
  'The worst thing to find in your grandmother\'s attic',
  'A bad slogan for a mattress company',
  'The worst possible name for a therapy app',
  'A terrible thing to say to a fortune teller',
  'Something you should never bring camping',
  'The worst name for a new dance craze',
  'A bad thing to be famous on the internet for',
  'The worst thing to say during a hostage negotiation',
  'A terrible name for a competitive eating champion',
  'Something a robot would do on its day off',
  'The worst possible thing to find in your soup',
  'A bad name for a kids\' summer camp',
  'The worst thing to say to your mother-in-law',
  'A terrible idea for a theme park ride',
  'The worst possible thing to yell during a wedding',
];
...
io.on('connection', (socket) => {
  ...
  socket.on('playAgain', () => {
    ...
    // Reshuffle seating so a 2nd/3rd game has a fresh guesser/reader order.
    const keep = shuffle(game.players.map((p) => ({ ...p, score: 0 })));
